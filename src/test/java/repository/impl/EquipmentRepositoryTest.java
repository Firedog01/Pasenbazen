...
class EquipmentRepositoryTest {
    ...
    ClientMgd client1 = DataFakerMgd.getClientMgd();
    ClientMgd client2 = DataFakerMgd.getClientMgd();
    ClientMgd client3 = DataFakerMgd.getClientMgd();
    CameraMgd camera  = DataFakerMgd.getCameraMgd();
    LensMgd   lens    = DataFakerMgd.getLensMgd();
    TrivetMgd trivet  = DataFakerMgd.getTrivetMgd();
    ...
    void update_remove() {
        ...
        Equipment e2 = DataFaker.getCamera();
